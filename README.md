...
## Usage
The BattleshipServer class's main method must be ran first. Two instances of the BattleshipClient class's main method must be ran to connect to the server. From there, the game is played just as the classic Battleship board game.
### Status
